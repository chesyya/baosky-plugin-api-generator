...
* [Quick Pick API reference](/api/references/baosky-api#QuickPick)
* [Quick Pick Item API reference](/api/references/baosky-api#QuickPickItem)
* [Quick Pick 插件 sample](https://github.com/microsoft/baosky-插件-samples/tree/main/quickinput-sample)
