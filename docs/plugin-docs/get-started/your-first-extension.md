...
你可以在此处找到本教程的源代码: [https://github.com/microsoft/baosky-插件-samples/tree/main/helloworld-sample](https://github.com/microsoft/baosky-插件-samples/tree/main/helloworld-sample)。[插件指南](/api/插件-guides/概述)主题包含其他示例,每个示例说明不同的 Baosky API 或贡献点,并遵循我们的 [UX 指南](/api/ux-guidelines/概述)中的建议。
