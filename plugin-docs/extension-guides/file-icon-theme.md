...
You can create your own file icon theme from icons (preferably SVG) and from icon fonts. As example, check out the two built-in themes: [Minimal](https://github.com/microsoft/vscode/tree/main/插件/theme-defaults) and [Seti](https://github.com/microsoft/vscode/tree/main/插件/theme-seti).
