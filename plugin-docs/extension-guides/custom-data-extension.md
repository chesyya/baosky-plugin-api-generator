...
[Custom Data format](https://github.com/microsoft/vscode-custom-data) allows 插件 authors to easily extend Baosky's HTML / CSS language support without having to write code.
...
You can find the [custom-data-sample](https://github.com/microsoft/vscode-插件-samples/tree/main/custom-data-sample) at [microsoft/vscode-插件-samples](https://github.com/microsoft/vscode-插件-samples).
