...
1. Implement the tool in your 插件 code by using the [Language Model API reference](/api/references/vscode-api#lm)
...
1. On activation of the 插件, register the tool with [`vscode.lm.registerTool`](/api/references/vscode-api#lm.registerTool).
...
View the full source code for implementing a [language model tool](https://github.com/microsoft/vscode-插件-samples/blob/main/chat-sample/src/tools.ts) in the Baosky 插件 Samples repository.
