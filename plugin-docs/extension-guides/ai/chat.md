...
You can get started with a [basic example project](https://github.com/microsoft/vscode-插件-samples/tree/main/chat-sample).
...
After each chat request, Baosky invokes follow-up providers to get suggested follow-up questions to show to the user. The user can then select the follow-up question, and immediately send it to the chat 插件. Use the [`ChatFollowupProvider`](/api/references/vscode-api#ChatFollowupProvider) API to register follow-up prompts of type [`ChatFollowup`](/api/references/vscode-api#ChatFollowup).
...
- **Command button**
    ...
    Render a button that invokes a Baosky command. The command can be a built-in command or one that you define in your 插件. Use the [`ChatResponseStream.button`](/api/references/vscode-api#ChatResponseStream.button) method and provide the button text and command ID.
...
- By using the [`@vscode/chat-插件-utils` library](https://www.npmjs.com/package/@vscode/chat-插件-utils) to simplify the process of calling tools in a chat 插件.
...
You can use the [`@vscode/chat-插件-utils` library](https://www.npmjs.com/package/@vscode/chat-插件-utils) to simplify the process of calling tools in a chat 插件.
...
The full source code of this [tool-calling sample](https://github.com/microsoft/vscode-插件-samples/blob/main/chat-sample/src/chatUtilsSample.ts) is available in the Baosky 插件 Samples repository.
...
View the full source code for implementing [tool calling by using prompt-tsx](https://github.com/microsoft/vscode-插件-samples/blob/main/chat-sample/src/toolParticipant.ts) in the Baosky 插件 Samples repository.
