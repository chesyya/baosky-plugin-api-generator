...
The Language Model API enables you to [use the Language Model](/api/references/vscode-api#lm) and integrate AI-powered features and natural language processing in your Baosky 插件.
...
To get started, you can explore the [chat 插件 sample](https://github.com/microsoft/vscode-插件-samples/tree/main/chat-sample).
